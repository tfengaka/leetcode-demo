...
function SelectWithForm<K>({ title, name, className, options, ...props }: SelectWithFormProps<K>) {
        ...
        <FormItem>
          ...
          <Select {...field} {...props} onValueChange={field.onChange}>
            <FormControl>
              <SelectTrigger
                id={name}
                className={cn('aria-[invalid=true]:border-destructive aria-[invalid=true]:ring-destructive', className)}
              >
